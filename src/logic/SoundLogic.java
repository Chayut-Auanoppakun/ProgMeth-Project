...
public class SoundLogic {
	private static final double SOUND_RANGE = 30.0;
	private static final String WALK_SOUND_PATH = "assets/FootstepCarpet01.wav";
	private static final String OTHER_WALK_SOUND_PATH = "assets/FootstepTile01.wav";
